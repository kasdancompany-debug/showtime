...
/**
 * Dev only: save an image under `public/screen-posters/` so `/screen-posters/…` works on /screen.
 */
export async function POST(req: Request) {
  ...
  try {
    ...
    const dir = path.join(process.cwd(), "public", "screen-posters");
    ...
    const publicPath = `/screen-posters/${outName}`;
